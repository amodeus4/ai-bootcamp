...
def _run_agent_stream(
    user_input: str, agent, tool_q: "queue.Queue[str]", text_q: "queue.Queue[str]"
):
    async def _do():
...
def main():
    ...
    with st.chat_message("assistant"):
        ...
        assistant_markdown = _stream_to_ui(
            text_q, tool_q, tools_placeholder, output_placeholder
        )
